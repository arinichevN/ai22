...
DEF_FUN_AOID_SERVER_SEND_SUPPORTED_COMMAND(SS, VARGS({CMD_AOID_START, CMD_AOID_STOP}))
DEF_FUN_AOID_SERVER_SEND_SUPPORTED_COMMAND(Set, VARGS({CMD_AOID_SET_NVRAM_VALUE}))
