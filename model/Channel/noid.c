...
static int channel_noidSupportedCommands(int command){
	switch(command){
		case CMD_NOID_GET_FTS: case CMD_NOID_GET_STATE: case CMD_NOID_GET_ERROR:case CMD_NOID_START:case CMD_NOID_STOP:case CMD_NOID_GET_EXISTS:case CMD_NOID_GET_DEVICE_KIND:
			return 1;
	}
	return 0;
}
