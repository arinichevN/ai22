...
DEF_FUN_NOID_SERVER_SEND_SUPPORTED_COMMAND(Chn, VARGS({CMD_NOID_GET_FTS, CMD_NOID_GET_STATE, CMD_NOID_GET_ERROR, CMD_NOID_START, CMD_NOID_STOP, CMD_NOID_GET_EXISTS, CMD_NOID_GET_DEVICE_KIND}))
